...
class ApiClient {
  ...
  async linkBusiness(oneTimeCode, userId) {
    return this.request('POST', '/api/wc-commission/link-business', {
  ...
  async getCommissionPayouts(affiliateId, startDate = null, endDate = null) {
    ...
    return this.request('GET', `/api/wc-commission/commission-payouts?${params}`);
  }

  async markCommissionsPaid(paymentData) {
    return this.request('POST', '/api/wc-commission/mark-commissions-paid', paymentData);
  }
